...
<html lang="en" class="no-js">
	<head>
		...
		<meta name="description" content="Add, Remove, Edit Questions for Mind Freezer 3.0" />
		...
		<link href="css/jquery-fallr-2.0.1.css" rel="stylesheet">
	...
	<body>
		...
		<div class="container-fluid">
			<ul id="gn-menu" class="gn-menu-main">
				...
				<li id="ml1"><a href="admin_dashboard.php" class="active-tab"><i class="fas fa-home"></i><span class = "menu-text1">Questions</span></a></li>
