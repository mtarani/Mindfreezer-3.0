	...
	<body>
		...
		<div class="container-fluid">
			<ul id="gn-menu" class="gn-menu-main">
				...
				<li id="ml3"><a href="player_leaderboards.php" class="active-tab"><i class="fas fa-trophy"></i><span class = "menu-text3">Leaderboards</span></a></li>
			...
			<header id="main-window">
				...
				<div class="row">
					...
					<div class="row">
					<div class="col-md-8 mx-auto d-block">
						<p>Prizes to winners and and special consolation prizes will be announced on facebook page of <a href="https://www.facebook.com/scanitjsr/">Society of Computer Applications</a> so stay tuned to Mind Freezer 3.0</p>
					</div>
				</div>
				</div>
